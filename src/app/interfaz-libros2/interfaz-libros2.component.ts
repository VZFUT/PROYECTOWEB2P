...
@Component({
  selector: 'app-interfaz-libros2',
  standalone: true,
  imports: [CommonModule, HttpClientModule],
  templateUrl: './interfaz-libros2.component.html',
  styleUrl: './interfaz-libros2.component.css',
  encapsulation: ViewEncapsulation.None 
})
export class InterfazLibros2Component implements OnInit {
